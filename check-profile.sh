...
valgrind --tool=callgrind --callgrind-out-file=callgrind.ubjsc.out \
    ./test-ubjsc > /dev/null
callgrind_annotate callgrind.ubjsc.out

valgrind --tool=callgrind --callgrind-out-file=callgrind.ubjsc-glues.out \
    ./test-ubjsc-glues > /dev/null
callgrind_annotate callgrind.ubjsc-glues.out

valgrind --tool=callgrind --callgrind-out-file=callgrind.ubjsc-glue-dict-ptrie.out \
