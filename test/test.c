...
atest tests[] =
{
    ...
    {"parser: str with length negative int8", test_parser_str_int8_negative},
    {"parser: str with length int16", test_parser_str_int16},
    {"parser: str with length negative int16", test_parser_str_int16_negative},
    {"parser: str with length int32", test_parser_str_int32},
    {"parser: str with length negative int32", test_parser_str_int32_negative},
