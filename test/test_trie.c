...
void test_trie_1_item() {
    ...
    CU_ASSERT_EQUAL(nvalue, value);
    CU_ASSERT_EQUAL(UR_OK, ubjs_trie_delete(trie, 3, "aaa"));
    CU_ASSERT_EQUAL(UR_ERROR, ubjs_trie_delete(trie, 3, "aaa"));
    CU_ASSERT_EQUAL(UR_OK, ubjs_trie_delete(trie, 1, "a"));
    CU_ASSERT_EQUAL(UR_ERROR, ubjs_trie_delete(trie, 1, "a"));
    CU_ASSERT_EQUAL(UR_ERROR, ubjs_trie_delete(trie, 3, "abb"));
    CU_ASSERT_EQUAL(UR_OK, ubjs_trie_free(&trie));
}
